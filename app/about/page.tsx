    ...
    <div className='font-sans bg-gray-100 text-gray-800'>
      ...
      <section className='py-16 px-8 bg-gray-100'>
        ...
        <div className='max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8'>
          <AboutUsCard title="Comprehensive Tracking" description="Monitor your sleep patterns and identify areas for improvement." />
          <AboutUsCard title="Personalized Insights" description="Receive tailored recommendations to enhance your sleep quality." />
          <AboutUsCard title="Daily diary entries" description="Log daily entries to track habits affecting your sleep." />
        </div>
      </section>
